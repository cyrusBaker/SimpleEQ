...
struct ChainSettings {
    ...
    Slope lowCutSlope { Slope::Slope_12 }, hiCutSlope { Slope::Slope_12 };
};
...
inline auto makeHiCutFilter(const ChainSettings& chainSettings, double sampleRate) {
    return juce::dsp::FilterDesign<float>::designIIRLowpassHighOrderButterworthMethod(chainSettings.hiCutFreq, sampleRate, 2 * (chainSettings.hiCutSlope + 1));
}
